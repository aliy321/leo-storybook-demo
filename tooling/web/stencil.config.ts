...
const leoPackagePaths: Record<string, string> = {
  ...
  '@leo/ui/badge': path.resolve(__dirname, '../../packages/ui/dist/badge/index.js'),
  '@leo/ui/alert': path.resolve(__dirname, '../../packages/ui/dist/alert/index.js'),

  '@leo/tokens': path.resolve(__dirname, '../../packages/tokens/dist/index.js'),
...
const leoWatchFiles = [
  ...
  path.resolve(__dirname, '../../packages/ui/dist/badge/core/badge.core.js'),
  path.resolve(__dirname, '../../packages/ui/dist/alert/core/alert.core.js'),

  path.resolve(__dirname, '../../packages/tokens/dist/icon-set.js'),
...
export const config: Config = {
  ...
  excludeSrc: [
    ...
    '../../packages/ui/src/**/AlertTextContext.tsx',
    '../../packages/ui/src/**/AlertText.tsx',
    '../../packages/ui/src/**/AlertTitle.tsx',
    '../../packages/ui/src/**/AlertDescription.tsx',
